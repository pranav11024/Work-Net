						...
						<div class="search">
											...
											<div class="box">
												...
												<div class="catagory">
													...
													<div class="btn-group bootstrap-select open">
														<select name="search-categories" class="selectpicker" id="search-categories" data-live-search="true" title="Choose Category" data-size="5" data-container="body" tabindex="-98">
							...
							<div class="jp_rightside_job_categories_wrapper" style="margin-left: 10px">
								...
								<div class="jp_rightside_job_categories_content">
									...
									<label for="" class="eg">e.g:Mumbai, Bangalore, <br> Delhi</label>
								</div>
							</div>
